...
export default function FAQ({ translations: t }: FAQProps) {
  ...
  return (
    <section id="faq" className="relative py-24 lg:py-32 bg-white dark:bg-slate-900 scroll-mt-40">
      <div className="w-full px-6 lg:px-12 xl:px-20">
        ...
        >
          {FAQ_KEYS.map((key, index) => {
            ...
            const faqData = t.faq.questions[key];
            return (
              <motion.div
                key={key}
              ...
              >
                ...
                <AnimatePresence>
                  {isOpen && (
                    ...
                    >
                      <p className="pb-6 text-slate-600 dark:text-slate-400 leading-relaxed">{faqData.a}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </motion.div>
